...
// biome-ignore lint/suspicious/noShadowRestrictedNames: Map is a standard component name for map libraries
  ...
  return (
    <ControlButton onClick={onClick} label="Reset bearing to north">
      <svg
        ...
        role="img"
        aria-label="Compass indicating map rotation"
      >
        <title>Compass indicating map rotation</title>
